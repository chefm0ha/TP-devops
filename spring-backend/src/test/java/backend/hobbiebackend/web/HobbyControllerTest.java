...
public class HobbyControllerTest extends AbstractTest {
    ...
    public void setUp() {
        ...
        hobbyInfoDto.setProfileImgId("id");
        hobbyInfoDto.setGalleryImg1Id("id");
        hobbyInfoDto.setGalleryImg2Id("id");
        hobbyInfoDto.setGalleryImg3Id("id");
        ...
        hobbyInfoUpdateDto.setProfileImgId("id");
        hobbyInfoUpdateDto.setGalleryImg1Id("id");
        hobbyInfoUpdateDto.setGalleryImg2Id("id");
        hobbyInfoUpdateDto.setGalleryImg3Id("id");
